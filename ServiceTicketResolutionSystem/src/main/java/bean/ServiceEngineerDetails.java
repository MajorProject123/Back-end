...
public class ServiceEngineerDetails {
	...
	@ManyToOne
	@JoinColumn(name = "CurrentTicketPriority")
	...
	public String toString() {
		return "ServiceEngineerDetails [CurrentHighPriorityTicketID=" + CurrentHighPriorityTicketID + ", ID=" + ID
				+ ", TotalTicketsWorkedOn=" + TotalTicketsWorkedOn + ", credentials=" + credentials + ", departments="
				+ departments + ", priorities=" + priorities + "]";
	}
}
